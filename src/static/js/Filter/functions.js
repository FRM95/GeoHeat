...
const resetFilterOptions = (domElement, nodesClass) => {
...
const setFilterOptions = (boxKey, boxValue) =>{
    switch (boxKey) { 
        case "country":
...
export function FilterOptions() {
    ...
    /* Save filter button Event functionality */
    const saveFilter = document.getElementById("save-button");
    saveFilter.addEventListener("click", () => {
        const boxes = document.getElementsByClassName("summary-checkbox");
        if(boxes != null){
            const filtersToApply = filteredOptions(boxes);
